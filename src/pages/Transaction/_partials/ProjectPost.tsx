        ...
        <Content>
            <form onSubmit={handleSubmit(createProject)}>
                ...
                >
                    ...
                    <>
                        ...
                        <FormControl sx={{ mt: 1, mb: 2 }} size="small" fullWidth>
                            ...
                            />
                            {errors.title && <span style={{ fontSize: '14px', color: "red" }}>{String(errors?.title?.message)}</span>}
                        </FormControl>
                    </>
                    <>
                        <Typography variant='body2' color={'#4F4F4F'} fontWeight={500} sx={{ mt: 2 }}>
                ...
                >
                    ...
                    <Grid container sx={{ mt: 3, alignItems: 'center', justifyContent: 'space-between' }} spacing={1}>
                        <Grid item>
                            <ImageUploader />
                        </Grid>
                        <Grid item sx={{ mt: '101px' }}>
                            <Box sx={{ display: 'flex', gap: 2 }}>
                                <Button variant="contained" color='success'>Save as Draft</Button>
...
export const ProjectPost = memo(ProjectPostMemo)